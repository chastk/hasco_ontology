...
HASCO_DIR='hasco.d/'
SETL_FILE='hasco_ontology.setl.ttl'
...
def build():
    ...
    ontology_output_files = [setl_graph.resource(URIRef('file://'+cwd+'/hasco.'+x)) for x in formats]
    for filename in os.listdir(HASCO_DIR):
        ...
        fragment_extract.add(prov.used, URIRef('file://'+HASCO_DIR+filename))
